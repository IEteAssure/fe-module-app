...
const ControlledForm = () => {
  ...
  return (
    <form
      ...
      className="w-1/2 mx-auto p-6 text-white rounded-xl shadow space-y-6"
    >
      <h2 className="text-2xl font-bold text-white">Controlled Form</h2>

      <div className="flex flex-col">
        <label className="mb-1 text-sm font-medium text-white">Name</label>
        <input
          type="text"
          name="name"
          value={formData.name}
      ...
      <div className="flex flex-col">
        <label className="mb-1 text-sm font-medium text-white">Age</label>
        <input
          type="number"
          name="age"
          value={formData.age}
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          onChange={handleChange}
          className="border bg-gray-900  text-white border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300"
        >
